...
struct ContentView: View {
    ...
    var body: some View {
        if showConnections{
            ...
            MainView(value: 50.0, selected_position: CGPoint(x:150,y:150),showConnections: $showConnections,showAudio: $showAudio,showAnimation: $showAnimation, chosenMode:$AVImode,isConnected: $connectionStatus)
                .environmentObject(ble_Manager)
